...
import com.example.coba_app.MenuAdapter
                ...
                api.deleteMenu(menu.id).enqueue(object: Callback<ResponseModel> {
                    override fun onResponse(
                        ...
                        if(!response.isSuccessful){
                            ...
                            Helper.message(errors.getString("errors"), this@MainActivity, false)
                        } else {
                            Helper.message(response.body()!!.message, this@MainActivity, false)
                            onStart()
                        }
                    }
